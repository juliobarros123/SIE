      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          ...
          <a class="navbar-brand brand-logo mr-5" href="{{ route('sie') }}"><img src="/site/assets/images/logo-v1.png" class="mr-2" alt="logo"/></a>
          ...
          <ul class="navbar-nav mr-lg-2">
            <li class="nav-item nav-search d-none d-lg-block">
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="navbar-search-input" placeholder="Pesquisar agora..." aria-label="search" aria-describedby="search">
              </div>
            </li>
          </ul>
