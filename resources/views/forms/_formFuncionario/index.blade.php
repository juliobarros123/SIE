...
<div class="col-md-4">
    <label for="ya_anoValidade" class="form-label">Válido ate</label>
    <input type="number" class="form-control border-secondary"
        value="{{ isset($funcionario->ya_anoValidade) ? $funcionario->ya_anoValidade : date('Y') + 3 }}"
        name="ya_anoValidade" placeholder="Válido Ate" readonly>
</div>
<div class="col-md-4">
