...
<div class="form-group col-md-2" id="mac" >
    <label>MAC</label>
    <input type="number" min="0" max="20" step=".25" class="form-control border-secondary" placeholder="MAC"
        name="fl_mac" value="{{ isset($notas->fl_mac) ? $notas->fl_mac : '' }}">
</div>
<div class="form-group col-md-2">
    <label>Nota 1</label>
    <input type="number" min="0" max="20" step=".25" class="form-control border-secondary" placeholder="Nota 1"
        name="fl_nota1" value="{{ isset($notas->fl_nota1) ? $notas->fl_nota1 : '' }}" required>
</div>
<div class="form-group col-md-2" id="provadois" >
    <label>Nota 2</label>
    <input type="number" min="0" max="20" step=".25" class="form-control border-secondary" placeholder="Nota 2"
